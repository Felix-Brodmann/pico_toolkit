...
std::tuple<std::unique_ptr<Connection>, std::optional<Error>> Network::dial_tcp(const Address &address, uint32_t timeout_ms)
{
    ...
    auto conn = std::unique_ptr<TcpConnection>(new TcpConnection(state.connected_pcb, std::move(local_addr), std::move(remote_addr)));
...
std::tuple<std::unique_ptr<Listener>, std::optional<Error>> Network::listen_tcp(uint16_t port)
{
    ...
    auto listener = std::unique_ptr<TcpListener>(new TcpListener(pcb, std::move(local_addr)));
...
std::tuple<std::unique_ptr<Connection>, std::optional<Error>> Network::dial_udp(const Address &address)
{
    ...
    auto conn = std::unique_ptr<UdpConnection>(new UdpConnection(pcb, std::move(local_addr), std::move(remote_addr)));
...
std::tuple<std::unique_ptr<Listener>, std::optional<Error>> Network::listen_udp(uint16_t port)
{
    ...
    auto listener = std::unique_ptr<UdpListener>(new UdpListener(pcb, std::move(local_addr)));
